...
// []*models.Movie is what we are going to use to populate our graph variable
// *Graph is defined on line 9
func New(movies []*models.Movie) *Graph {
	...
	var fields = graphql.Fields{
		...
		"list": &graphql.Field{
			...
			// what will happen when we execute this action
		...
		"search": &graphql.Field{
			...
			// Specify the argument you are searching for
...
// getting our instructions for what we want to do from this graph type
